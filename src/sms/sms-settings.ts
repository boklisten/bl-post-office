  ...
  text: {
    ...
    reminder: {
      'partly-payment': [
        ...
        'I tillegg til våre stands og postsending, kan du ved Sonans Oslo, Akademiet Oslo og Metis Oslo også levere bøker i våre innleveringsskap. Pass på at du kun leverer bøker med unik ID - eller legg en post-it med navn og telefonnummer i boken. Ta gjerne kontakt med oss på info@boklisten.no om skapet er fullt.',
