  ...
  text: {
    ...
    reminder: {
      'partly-payment': [
        ...
        'Hei. Vi kan ikke se at du har betalt andre delbetaling av dine bøker. Vi har nå generert en faktura, men du skal få en siste mulighet til å betale. Absolutt siste frist er 31.12.2019. Se mail for mer info. Mvh Boklisten.no',
      ],
      rent: [
