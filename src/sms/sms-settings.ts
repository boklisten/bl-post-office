  ...
  text: {
    ...
    reminder: {
      'partly-payment': [
        ...
        'I tillegg til våre stands og postsending, kan du ved Sonans Oslo også levere bøker i vårt innleveringsskap. Pass på at du kun leverer bøker med unik ID - eller legg en post-it med navn og telefonnummer i boken. Ta gjerne kontakt med oss på info@boklisten.no om skapet er fullt.',
