export const SMS_SETTINGS = {
  ...
  text: {
    match: {
      none: [
        'Melding til deg med kundeavtale hos Boklisten.no: Vennligst gi oss beskjed om hva som skal skje med bøkene dine: boklisten.no/match?deadline=201219',
      ],
    },
    reminder: {
      'partly-payment': [
        ...
        'Hei! Du har bøker hvor andre avdrag straks forfaller. Kom innom for å selge bøkene tilbake til oss, eller betal andre avdrag på nettsidene våre. Se våre påminnelsesmailene våre for mer informasjon. Mvh Boklisten.no',
